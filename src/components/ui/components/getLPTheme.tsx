...
const getDesignTokens = (mode: PaletteMode) => ({
  palette: {
    ...
    background: {
      default: '#fff',
      paper: gray[50],
      ...(mode === 'dark' && { default: reserved[700], paper: reserved[600] }),
    },
    text: {
      primary: gray[900],
      secondary: gray[600],
      ...
      MuiAccordionSummary: {
        styleOverrides: {
          root: ({ theme }) => ({
            ...
            ...(theme.palette.mode === 'dark' && {
              '&:hover': { backgroundColor: reserved[700] },
            }),
          }),
        },
      },
          ...
          root: ({ theme, ownerState }) => ({
            ...
            ...(ownerState.variant === 'contained' &&
              ownerState.color === 'primary' && {
                ...
                ...(theme.palette.mode === 'dark' && {
                  color: reserved[50],
                  background: reserved[500],
                  backgroundImage: 'none',
                  boxShadow: 'none',
                  outline: 'none',
                  '&:hover': {
                    background: reserved[600],
                  },
                }),
              }),
            ...(ownerState.variant === 'contained' &&
              ownerState.color === 'secondary' && {
                ...(theme.palette.mode === 'light' && {
                  ...
                  backgroundImage: `linear-gradient(to bottom, ${secondary[400]}, ${secondary[600]})`,
                  boxShadow: `inset 0 1px ${alpha(secondary[300], 0.4)}`,
                  outline: `1px solid ${secondary[700]}`,
                  '&:hover': {
                    background: secondary[400],
                    backgroundImage: 'none',
                    boxShadow: `0 0 0 1px ${alpha(secondary[300], 0.5)}`,
                  },
                }),
                ...(theme.palette.mode === 'dark' && {
                  color: reserved[50],
            ...
            ...(ownerState.variant === 'outlined' &&
              ownerState.color === 'secondary' && {
                ...
                ...(theme.palette.mode === 'dark' && {
                  backgroundColor: alpha(reserved[300], 0.1),
                  borderColor: reserved[300],
                  color: reserved[200],
                  '&:hover': {
                    backgroundColor: alpha(reserved[300], 0.2),
                    borderColor: reserved[200],
                  },
                }),
              }),
            ...
            ...(ownerState.variant === 'text' &&
              ownerState.color === 'secondary' && {
                ...
                ...(theme.palette.mode === 'dark' && {
                  color: reserved[200],
                  '&:hover': {
                    backgroundColor: alpha(reserved[300], 0.3),
                    borderColor: reserved[200],
                  },
                }),
              }),
